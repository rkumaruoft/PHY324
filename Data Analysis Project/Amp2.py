...
fontsize = 14
plt.text(0.20, 55, r'$\mu$ = %3.2f keV' % (popt1[1]), fontsize=fontsize)
plt.text(0.20, 50, r'$\chi^2$/DOF=', fontsize=fontsize)
plt.text(0.20, 45, r'%3.2f/%i' % (chisquared1, dof1), fontsize=fontsize)
plt.text(0.20, 40, r'$\sigma$ = %3.2f keV' % (popt1[2]), fontsize=fontsize)
plt.text(0.20, 35, r'$\chi^2$ prob.= %1.1f' % (1 - chi2.cdf(chisquared1, dof1)), fontsize=fontsize)
plt.savefig("Plots/amp2_pre.png", dpi=200)
plt.show()
...
plt.legend(loc='upper right')
fontsize = 14
plt.text(7.8, 55, r'$\mu$ = %3.2f keV' % (popt1[1]), fontsize=fontsize)
plt.text(7.8, 50, r'$\chi^2$/DOF=', fontsize=fontsize)
plt.text(7.8, 45, r'%3.2f/%i' % (chisquared1, dof1), fontsize=fontsize)
plt.text(7.8, 40, r'$\sigma$ = %3.2f keV' % (popt1[2]), fontsize=fontsize)
plt.text(7.8, 35, r'$\chi^2$ prob.= %1.1f' % (1 - chi2.cdf(chisquared1, dof1)), fontsize=fontsize)
plt.savefig("Plots/amp2_post.png", dpi=200)
plt.show()
...
plt.legend()
plt.savefig("new_plots/amp2_residuals", dpi=200)
plt.show()